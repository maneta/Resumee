...
\begin{itemize}
\item Unix(RH,Debian,MacOS \& FreeBSD Based Systems), Configuration Management Tools (Puppet, Salt), Version Control Systems (Git, SVN), Xenserver, VM Ware ESX, Database (MySQL,MongoDB), Apache, Nginx, Varnish,LVM,ffmpeg/avconv, mod\_pagespeed, \\ 
mod\_security, mod\_evasive, iptables, DNS, Zimbra, qmail, dhcpd, DNS, Samba, mod\_perl, mod\_php, fastcgi, HAProxy, squid, Zebra, Quaggua \& pound.  
\end{itemize}
